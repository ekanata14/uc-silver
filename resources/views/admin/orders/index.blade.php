                            ...
                            <td class="p-4 align-middle">
                                @if ($order->payment_receipt)
                                    ...
                                    <div id="receipt-modal-{{ $order->id }}" tabindex="-1" aria-hidden="true"
                                        ...
                                        <div
                                            class="relative p-4 w-full max-w-2xl max-h-full flex justify-center items-center">
                                            <!-- Modal content -->
                                            <div
                                                class="relative bg-primary-light rounded-lg shadow-lg border-2 border-brown-medium scale-95 opacity-0 transition-all duration-300 receipt-modal-content">
                                                <!-- Modal header -->
                                                <div
                                                    class="flex items-center justify-between p-4 md:p-5 border-b rounded-t border-brown-medium bg-brown-medium">
                                                ...
                                                <!-- Modal body -->
                                                <div
                                                    class="p-4 md:p-5 space-y-4 flex justify-center items-center bg-primary-lighter">
                                                    <img src="{{ asset('storage/' . $order->payment_receipt) }}"
                                                        alt="Payment Receipt"
                                                        class="max-w-full max-h-96 rounded shadow-lg border border-brown-medium">
                                                </div>
                                                <!-- Modal footer -->
                                                <div
                                                    class="flex items-center p-4 md:p-5 border-t border-brown-medium rounded-b bg-brown-light">
                                                    <button type="button"
