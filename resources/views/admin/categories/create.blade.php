...
@section('content')
    <h1 class="text-2xl font-bold text-primary-lighter mb-6">Add Category</h1>
    ...
    <form action="{{ route('admin.categories.store') }}" method="POST" class="bg-background p-6 rounded shadow max-w-lg">
        @csrf
        ...
        <button type="submit" class="bg-primary text-white px-4 py-2 rounded hover:bg-primary-dark">Add Category</button>
